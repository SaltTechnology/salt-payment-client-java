...
public class StorageReceipt extends AbstractReceipt {
    ...
    private final static String STORAGE_TOKEN_ID = "STORAGE_TOKEN_ID";
    private final static String PAYMENT_PROFILE_AVAILABLE = "PAYMENT_PROFILE_AVAILABLE";
    private final static String CREDIT_CARD_AVAILABLE = "CREDIT_CARD_AVAILABLE";
    private final static String CREDIT_CARD_NUMBER = "CREDIT_CARD_NUMBER";
    private final static String EXPIRY_DATE = "EXPIRY_DATE";
    private final static String CUSTOMER_PROFILE_AVAILABLE = "CUSTOMER_PROFILE_AVAILABLE";
    private final static String CUSTOMER_PROFILE_LEGAL_NAME = "CUSTOMER_PROFILE_LEGAL_NAME";
    private final static String CUSTOMER_PROFILE_TRADE_NAME = "CUSTOMER_PROFILE_TRADE_NAME";
    private final static String CUSTOMER_PROFILE_WEBSITE = "CUSTOMER_PROFILE_WEBSITE";
    private final static String CUSTOMER_PROFILE_FIRST_NAME = "CUSTOMER_PROFILE_FIRST_NAME";
    private final static String CUSTOMER_PROFILE_LAST_NAME = "CUSTOMER_PROFILE_LAST_NAME";
    private final static String CUSTOMER_PROFILE_PHONE_NUMBER = "CUSTOMER_PROFILE_PHONE_NUMBER";
    private final static String CUSTOMER_PROFILE_FAX_NUMBER = "CUSTOMER_PROFILE_FAX_NUMBER";
    private final static String CUSTOMER_PROFILE_ADDRESS1 = "CUSTOMER_PROFILE_ADDRESS1";
    private final static String CUSTOMER_PROFILE_ADDRESS2 = "CUSTOMER_PROFILE_ADDRESS2";
    private final static String CUSTOMER_PROFILE_CITY = "CUSTOMER_PROFILE_CITY";
    private final static String CUSTOMER_PROFILE_PROVINCE = "CUSTOMER_PROFILE_PROVINCE";
    private final static String CUSTOMER_PROFILE_POSTAL = "CUSTOMER_PROFILE_POSTAL";
    private final static String CUSTOMER_PROFILE_COUNTRY = "CUSTOMER_PROFILE_COUNTRY";
